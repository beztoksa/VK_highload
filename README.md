...
| **`search_index`**     | Индекс поиска                                          | id(8) + subject(255) + message_uid(255) + sent_at(8) + body_id(8) + reply_to(8) + thread_id(8) + is_draft(1) + created_at(8) = 543 Б | 110 млрд         | 543 Б × 110 000 000 000 = 54 ТБ          | 2 818 + 8 054 + 5 236 + 802 = 16 910                    | 3 100 + 6 443 = 9 543                                                        |
...
| **SeaweedFS (S3-совместимое хранилище)** | Объектное хранилище               | Для хранения вложений писем                                                                                                                                                                             |
