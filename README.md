...
| **S3**            | Одновременная запись в s3 и кафку, чтобы были две копии события загрузки. Хранение двух экземпляров файла |
...
| GO         | легкое JSON API       | 5000 |   0,2    |
| GO         | средняя бизнес-логика | 250  |   0,7    |
| GO         | тяжелая бизнес-логика | 100  |    2     |
### Ресурсы на сервисы 
| Сервис              | Назначение                                                     | Пиковая нагрузка (RPS) |     CPU | RAM (ГБ) |
|---------------------|----------------------------------------------------------------|-----------------------:|--------:|---------:|
| auth                | Авторизация                                                    |                 23 630 |       5 |        1 |
| API Gateway         | Обработка API запросов: поход в узкоспециализированные сервисы |                 23 630 |       5 |        1 |
| message reader      | Чтение одного сообщения                                        |                  5 236 |      21 |       15 |
| mail processor      | Главный обработчик записи метаданных писем                     |                  3 100 |      13 |        9 |
| search mail         | Сервис для обработки поисковых запросов                        |                    802 |       4 |        3 |
| search index worker | Обновление индексов для поиска                                 |                  3 100 |      31 |       62 |
| SMTP convertor      | Конвертация в SMTP-формат и обратно                            |                  5 835 |      59 |      117 |
| out SMTP            | Отдача, упаковка внешних писем                                 |                  2 170 |       9 |        7 |
| in SMTP             | Прием, обработка внешних писем                                 |                  3 665 |      15 |       11 |
| antispam filter     | Проверка писем на спам                                         |                  3 665 |      15 |       11 |
| **Итог**            |                                                                |             **74 834** | **177** |  **237** |

| База данных / Хранилище      | Нагрузка на чтение (QPS) | Нагрузка на запись (QPS) |     CPU | RAM (ГБ) |
|------------------------------|-------------------------:|-------------------------:|--------:|---------:|
| PostgreSQL messages metadata |                   60 840 |                   33 944 |      60 |       50 |
| ElasticSearch search index   |                      802 |                    9 543 |      50 |       50 |
| Redis sessions               |                    2 818 |                      141 |       3 |        4 |
| PostgreSQL users addresses   |                   19 728 |                    1 095 |      10 |       15 |
| S3 body attachments          |                   22 146 |                   12 406 |       5 |       20 |
| S3 temp SMTP messages        |                   22 146 |                   12 406 |       5 |       20 |
| **Итог**                     |              **128 480** |               **69 535** | **133** |  **159** |
...
|:---------------------------------|:--------|:------------------------------------------------------------|:----:|:------:|:-----------:|:--------------:|
| **kubenode (Go-сервисы)**        | own     | 2×AMD EPYC 7543 / 8×32ГБ / 2×NVMe 4ТБ / 2×25GbE             |  64  |   3    |    8 000    |      500       |
...
| **kafka**                        | own     | 2×Intel Xeon Silver 4314 / 4×32ГБ / 6×NVMe 4ТБ / 2×25GbE    |  16  |   1    |    7 500    |      300       |
| **Итог**                         |         |                                                             |      |        | **131 500** |   **5 500**    |
### Таблица ресурсов сервисов 
| Сервис              | CPU requests | CPU limits | RAM requests | RAM limits | Кол-во реплик |
|:--------------------|:------------:|:----------:|:-------------|:-----------|:-------------:|
| auth                |      5       |     5      | 1 ГБ         | 2 ГБ       |       4       |
| API Gateway         |      5       |     5      | 1 ГБ         | 2 ГБ       |       4       |
| message reader      |      21      |     21     | 18 ГБ        | 24 ГБ      |       4       |
| mail processor      |      13      |     13     | 11 ГБ        | 16 ГБ      |      12       |
| search mail         |      4       |     4      | 4 ГБ         | 6 ГБ       |      24       |
| search index worker |      31      |     31     | 74 ГБ        | 96 ГБ      |       3       |
| SMTP convertor      |      59      |     59     | 140 ГБ       | 192 ГБ     |      10       |
| out SMTP            |      9       |     9      | 9 ГБ         | 12 ГБ      |       3       |
| in SMTP             |      15      |     15     | 14 ГБ        | 20 ГБ      |       3       |
| antispam filter     |      15      |     15     | 14 ГБ        | 20 ГБ      |       3       |
