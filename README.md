...
Пиковый RPS: 21 284
Если поставить сетевую карту на 100 Гбит/c на каждый nginx, то nginx с 16 ядрами будет иметь 88 Гбит/c
305/88 = 3.4. С учетом резервирования N+1 нужно 5 балансировщиков
