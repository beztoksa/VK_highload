...
Пусть на одно соединение приходиться 10 запросов, тогда пиковый CPS равен 2 128.
Один nginx на 16 ядрах способен выдерживать 6 675 CPS, следовательно, упор идет в пропускную способность, а не в SSL терминацию. \
